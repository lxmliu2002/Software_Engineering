...
const routes = [
    {
        ...
        redirect: '/visualization',  //默认跳转到miserware路由
        hidden: true,
        children: [
            {
                path: 'miseruser',
            ...
            },
            {
                path: 'visualization',
                name: 'Visualization',
                component: () => import(/* webpackChunkName: "visualization" */ '../views/visualization/Visualization')
            },
            {
                path: 'loganalysis',
                name: 'Loganalysis',
                component: () => import(/* webpackChunName:"misercart" */ '../views/logAnalysis/LogAnalysis')
            },
            {
                path: 'loganalysisTab',
                name: 'loganalysisTab',
                component: () => import(/* webpackChunName:"misercart" */ '../views/logAnalysis/LogAnalysisTab')
            },
            {
                path: 'fileupload',
                name: 'Fileupload',
                component: () => import(/* webpackChunName:"misercart" */ '../views/fileUpload/FileUpload')
            },
        ]
    },
    {
